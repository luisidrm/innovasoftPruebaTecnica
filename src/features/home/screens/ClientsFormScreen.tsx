...
export default function ClientFormScreen() {
    ...
    // Manejar navegación a ErrorScreen cuando hay error
    useEffect(() => {
        if (message) {
            // Guardar el mensaje antes de limpiarlo
            const errorMessage = message;

            // Limpiar el error ANTES de navegar para evitar loop
            clearError();

            // Navegar con el mensaje guardado
    ...
    const handleCreateOrUpdate = async () => {
        ...
        if (clientId) {
            await updateClient({ id: clientId, ...payload }).then(() => {
        ...
        >
            ...
            >
                ...
                <View style={styles.buttonsRow}>
                    <TouchableOpacity style={styles.deleteBtn} onPress={() => navigation.navigate("ErrorScreen", {
